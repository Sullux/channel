...
function runEngine(args) {
  return new Promise((resolve) => {
    ...
    const cfg = framing.configFrame(512, 0.0, 1.0, 0.0, 40, 1); // Greedy argmax 40 tokens
